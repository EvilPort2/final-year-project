...
def trainDetector():
    ...
    path = "dataset"
    faces, IDs = getImageAndId("modules/face_lock_unlock/face_recognition/dataset")
    recog.train(faces, np.array(IDs))
    recog.write("modules/face_lock_unlock/face_recognition/recognized/training.yml")
